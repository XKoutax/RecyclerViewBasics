...
public class GridVRvActivity extends AppCompatActivity {


    private static final String TAG = "GridVRvActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grid_v_rv);

        addBtn = findViewById(R.id.grid_v_rv_add_button);
        recyclerView = findViewById(R.id.grid_v_rv);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_infinite_rv:
                Intent infiniteRvIntent = new Intent(GridVRvActivity.this, InfiniteRvActivity.class);
                startActivity(infiniteRvIntent);
                finish();
                return true;

            case R.id.menu_reverse_rv:
                Intent reverseRvIntent = new Intent(GridVRvActivity.this, ReverseRvActivity.class);
                startActivity(reverseRvIntent);
                finish();
                return true;

            case R.id.menu_horizontal_rv:
                Intent horizontalRvIntent = new Intent(GridVRvActivity.this, HorizontalRvActivity.class);
            ...
            case R.id.menu_grid_h_rv:
                Intent gridHRvIntent = new Intent(GridVRvActivity.this, GridHRvActivity.class);
